...
/**
 * SISTEMA DINÂMICO DE LANÇAMENTO E COLORIZAÇÃO DE NOTAS SOLICITADO
 */
...
function renderNotasTable(atv) {
    ...
    ALUNOS.forEach(aluno => {
        ...
        // Define a classe de cor da nota final da atividade (Regra solicitada: Vermelho/Azul)
...
/**
 * VISÃO GERAL DE NOTAS (SOMA DIRETA SOLICITADA) COM ATUALIZAÇÃO DE CORES
 */
...
/**
 * OPERAÇÃO CENTRAL DE FECHAMENTO GLOBAL (SOLICITAÇÃO EXPLICITA DO USUÁRIO)
...
/**
 * EXPORTAÇÃO EM FORMATO DE TABELA - UMA FOLHA EXCLUSIVA POR ALUNO (SOLICITAÇÃO DO USUÁRIO)
 */
